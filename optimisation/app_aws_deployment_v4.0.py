...
def construct_matrix(combination_list, mydf):
    ...
    for i in combination_list:
        ...
        om_token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..68y2fyFaL70VLXsHwfzC2pbD7-9TmqyAIV5xfhnEQYc'
        routeType = 'pt'
        mode = ['TRANSIT', 'BUS']
