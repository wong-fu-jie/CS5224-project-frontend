...
class Recommendation(object):
    ...
    def demo_recommendation(self, userid, start_loc, time_stay, start_time):
    ...
    def get_sim_list(self, vector,user_item_list):
        '''
    ...
    def get_user_feature_matrix(self, userid):
        '''
    ...
    def get_recommendation(self, userid,start_loc,time_stay,start_time):
        '''
